...
computed using the FEM~(left) with those generated using the composite surrogate~(right). The two plots
...
Right: Reconstructed stress field using the surrogate model for the same set of inputs.}
\label{fig:RS_comp}
\end{figure}
