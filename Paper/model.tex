...
The process of laying the new powder on bulk material formed by previous scans was simulated 
...
\end{equation}
where $T$, $\rho$, $C_p$, $\kappa$, $Q_e$ denote the local temperature, average density, specific heat,  thermal conductivity, 
...
The beam radius~($r$) and the thermal penetration depth were fixed at 200 and 28
...
Simulations were performed on a workstation with a system configuration: Intel~Core~i7-4790~CPU, 
